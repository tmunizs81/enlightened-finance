...
export function TransactionAdvancedSearch({ filters, onChange, categories, accounts }: Props) {
  ...
  return (
    <div className="space-y-2">
      <Button variant="outline" size="sm" onClick={() => setOpen(!open)} className="gap-2 text-xs">
      ...
      {open && (
        <div className="glass-card space-y-3 p-4 duration-200 animate-in slide-in-from-top-2">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-1">
              ...
              >
                <SelectTrigger className="h-8 bg-secondary text-xs">
