...
const ACHIEVEMENTS = [
  {
    ...
    icon: "🚀",
    condition: (d: any) => d.totalTransactions >= 1,
  },
  {
    key: "ten_transactions",
    title: "Organizador",
    desc: "Registre 10 transações",
    icon: "📋",
    condition: (d: any) => d.totalTransactions >= 10,
  },
  {
    key: "fifty_transactions",
    title: "Mestre do Registro",
    desc: "Registre 50 transações",
    icon: "📊",
    condition: (d: any) => d.totalTransactions >= 50,
  },
  {
    key: "hundred_transactions",
    title: "Lendário",
    desc: "Registre 100 transações",
    icon: "🏆",
    condition: (d: any) => d.totalTransactions >= 100,
  },
  {
    key: "first_goal",
    title: "Sonhador",
    desc: "Crie sua primeira meta",
    icon: "🎯",
    condition: (d: any) => d.totalGoals >= 1,
  },
  {
    key: "goal_achieved",
    title: "Conquistador",
    desc: "Atinja 100% de uma meta",
    icon: "⭐",
    condition: (d: any) => d.goalsCompleted >= 1,
  },
  {
    key: "three_goals_done",
    title: "Imparável",
    desc: "Conclua 3 metas",
    icon: "🔥",
    condition: (d: any) => d.goalsCompleted >= 3,
  },
  {
    key: "first_budget",
    title: "Planejador",
    desc: "Crie seu primeiro orçamento",
    icon: "📐",
    condition: (d: any) => d.totalBudgets >= 1,
  },
  {
    key: "budget_discipline",
    title: "Disciplinado",
    desc: "Fique dentro do orçamento por 1 mês",
    icon: "🎖️",
    condition: (d: any) => d.withinBudget,
  },
  {
    key: "saver_10",
    title: "Poupador",
    desc: "Economize 10% da renda em um mês",
    icon: "🐷",
    condition: (d: any) => d.savingsRate >= 10,
  },
  {
    key: "saver_20",
    title: "Investidor Nato",
    desc: "Economize 20% da renda em um mês",
    icon: "💎",
    condition: (d: any) => d.savingsRate >= 20,
  },
  {
    key: "saver_30",
    title: "Mestre da Poupança",
    desc: "Economize 30% da renda em um mês",
    icon: "👑",
    condition: (d: any) => d.savingsRate >= 30,
  },
  {
    key: "multi_account",
    title: "Diversificado",
    desc: "Cadastre 3 contas diferentes",
    icon: "🏦",
    condition: (d: any) => d.totalAccounts >= 3,
  },
  {
    key: "streak_7",
    title: "Foco Semanal",
    desc: "7 dias seguidos sem gastos extras",
    icon: "🔥",
    condition: (d: any) => d.bestStreak >= 7,
  },
  {
    key: "streak_30",
    title: "Mês de Ferro",
    desc: "30 dias seguidos sem gastos extras",
    icon: "💪",
    condition: (d: any) => d.bestStreak >= 30,
  },
  {
    key: "emergency_fund",
    title: "Reserva Segura",
    desc: "Saldo cobre 3 meses de gastos",
    icon: "🛡️",
    condition: (d: any) => d.hasEmergencyFund,
  },
  {
    key: "categorizer",
    title: "Categorizador",
    desc: "Crie 5 categorias",
    icon: "🏷️",
    condition: (d: any) => d.totalCategories >= 5,
  },
  {
    key: "recurring_setup",
    title: "Automatizador",
    desc: "Configure 3 recorrentes",
    icon: "🔄",
    condition: (d: any) => d.totalRecurring >= 3,
  },
];
...
serve(async (req) => {
  ...
  try {
    ...
    const monthTx = transactions.filter(
      (t: any) => t.date >= firstDay && t.date <= lastDay && t.status === "paid",
    );
    ...
    const goalsCompleted = goals.filter(
      (g: any) => Number(g.current_amount) >= Number(g.target_amount),
    ).length;
    ...
    if (lastCheck !== today) {
      ...
      const totalYesterday = yesterdayExpenses.reduce(
