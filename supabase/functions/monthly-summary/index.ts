...
Retorne um resumo narrativo de 3-5 frases analisando a evolução, destacando categorias com maior variação e dando uma recomendação prática.`;
        ...
        messages: [
          {
            role: "system",
            content:
              "Você é um analista financeiro pessoal. Seja direto e use emojis com moderação.",
          },
              ...
              parameters: {
                ...
                properties: {
                  ...
                  verdict: {
                    ...
                    description: "Overall month assessment",
                  },
                  top_change_category: {
                    type: "string",
                    description: "Category with biggest change",
                  },
                  top_change_percent: {
                    type: "number",
                    description: "Percentage change of that category (negative = reduction)",
                  },
                },
    ...
    let aiSummary = {
      narrative: "",
      verdict: "neutral",
      top_change_category: null,
      top_change_percent: null,
    };
